...
# data_params = {'dataset_file': './data/MedleyDB/MSYNC-MedleyDB.tfrecord',
...
ex = dataset_interface.bach10_pipeline(data_params)
parsed_features = ex.make_one_shot_iterator().get_next()
