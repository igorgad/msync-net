...
ax1.imshow(np.abs(sz[0, :, :]), cmap='gray')
ax1.set_yticks(xticks)
ax1.set_yticklabels(xlabels)

ax2.imshow(np.real(sz[0, :, :]), cmap='gray')
ax2.set_yticks(xticks)
ax2.set_yticklabels(xlabels)

ax3.plot(np.abs(sz[0, :, -200:]).mean(1))
