...
def vgg_decoder(input, trainable=True, name=''):
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.UpSampling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block4/pool')(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.UpSampling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block3/pool')(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.UpSampling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block2/pool')(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.UpSampling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name+'vgg_decoder_block1/pool')(x)
