...
def branch_encoder(input, trainable=True, name=''):
    # Block 1
...
def branch_decoder(input, trainable=True, name=''):
    # Block 4
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block4/pool')(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block3/pool')(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name + 'vgg_decoder_block2/pool')(x)

    # Block 1
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv2D(64, (3, 3), strides=(1, 1), activation='relu', padding='same'), trainable=trainable, name=name+'vgg_decoder_block1/conv1')(input)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2), padding='same'), trainable=trainable, name=name+'vgg_decoder_block1/pool')(x)
